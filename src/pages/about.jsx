  ...
  <Page className="about">
    ...
    <section className="about__content">
      ...
      <ul className="about__text">
        ...
        <li className="about__line">In the future, I holie to expand my skills into more react related technologies such as React Native and Next.js.</li>
      </ul>
    </section>
    <section className="about__content">
      ...
      <ul className="about__text">
        ...
        <li className="about__line">When I'm not coding, I enjoy rock climbing, spending time with friends, and enjoying a nice bubbletea or coffee.</li>
